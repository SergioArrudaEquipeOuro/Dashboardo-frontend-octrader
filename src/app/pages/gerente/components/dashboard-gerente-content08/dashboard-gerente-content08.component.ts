...
@Component({
  selector: 'app-dashboard-gerente-content08',
  templateUrl: './dashboard-gerente-content08.component.html',
  styleUrls: ['./dashboard-gerente-content08.component.css']
})
export class DashboardGerenteContent08Component implements OnInit {
  user: User = {} as User;
  userForm!: FormGroup;
